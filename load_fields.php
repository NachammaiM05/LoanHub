...
$loan = $conn->query("SELECT l.*,concat(b.firstname,' ',b.lastname,' ')as name, b.mobile_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id where l.id = ".$loan_id);
